            ...
            <section class="pt-24 pb-16 sm:pb-24">
                <div>
                    <div class="space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0">
                        ...
                        <p
                            href="#"
                            class="text-sm font-medium text-primary-600 flex"
                        >
                            <svg class="w-4 h-[1.1rem] mr-3 text-primary-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    ...
                    <div
                        class="mt-12 sm:mt-16 grid grid-cols-2 gap-x-4 gap-y-10 md:grid-cols-4"
                    >
                        <div
                        ...
                        >
                            <div
                                class="h-56 w-full overflow-hidden bg-gray-200 lg:h-72 xl:h-80"
                            >
                                <img
                                    :alt="product.name"
                                    :src="product.image"
                        ...
                        <div
                            class="bg-white relative flex items-center justify-center h-56 w-full lg:h-72 xl:h-80 text-sm"
                        >
                            <ApplicationLogo class="w-4 h-auto absolute bottom-4 right-4"/>
                            More coming soon.
                        </div>
                    </div>
                </div>
